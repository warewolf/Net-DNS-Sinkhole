...
my $answer = $resolver->send( "www.microsoft.com", "A", "IN" );
is($answer->header->rcode,"NOERROR","Resolver whitelisted returns record");

$answer = $resolver->send( "www.richardharman.com", "A", "IN" );
is($answer->header->rcode,"IGNORE","Resolver non-whitelisted returns IGNORE");
